...
describe('Deck', function() {
  ...
  beforeEach(function() {
    card1 = new Card(1, `Which of the following is not an array prototype 
      method?`, ['array.filter', 'array.map', 'array.extrapolate'], 
    'array.extrapolate');
    card2 = new Card(2, `What is the index value of the first element in an 
      array?`, ['1', '0', 'null'], '0');
